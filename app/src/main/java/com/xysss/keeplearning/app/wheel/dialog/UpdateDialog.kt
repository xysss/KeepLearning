package com.xysss.keeplearning.app.wheel.dialog
...
import com.xysss.keeplearning.app.wheel.aop.CheckNet
import com.xysss.keeplearning.app.wheel.aop.Permissions
import com.xysss.keeplearning.app.wheel.aop.SingleClick
...
class UpdateDialog {
    ...
    class Builder(context: Context) : BaseDialog.Builder<Builder>(context) {
        ...
        private fun installApk() {
            appContext.startActivity(getInstallIntent())
        }
        ...
        private fun getInstallIntent(): Intent {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(appContext, BuildConfig.APPLICATION_ID + ".provider", apkFile!!)
